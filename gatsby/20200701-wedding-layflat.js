try {
    ...
    newText.addEventListener("click", function(event) {
        setTimeout(function() {
            var labelText = document.getElementsByClassName("pdp-form__field-label__value");
            var labelText0 = labelText[0];
            var labelText1 = labelText[1];
            var labelText2 = labelText[2];
            var labelText3 = labelText[3];
            var labelText4 = labelText[4];
            var labelText5 = labelText[5];
            if (labelText0) {
